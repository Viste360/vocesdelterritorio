    ...
    <main style={{ maxWidth: '800px', margin: '0 auto', padding: '80px 24px', fontFamily: 'Inter, sans-serif', lineHeight: 1.6 }}>
      ...
      <section style={{ marginBottom: '48px' }}>
        ...
        <p>
          ...
          sin royalties ni obligaciones futuras, facilitando su uso libre en actos oficiales,
          eventos culturales, centros educativos y materiales audiovisuales.
        </p>
      </section>
